        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 font-mono">
              Compete with fellow agents and climb the ranks
            </p>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="glass-effect rounded-lg p-6 text-center">
              ...
              <div className="text-gray-400 text-sm font-mono">Highest points earned</div>
            </div>
            
            <div className="glass-effect rounded-lg p-6 text-center">
              <div className="text-3xl font-bold text-accent-orange font-mono mb-2">📈</div>
              <div className="text-white font-semibold mb-1">Rising Star</div>
              <div className="text-gray-400 text-sm font-mono">Fastest level progression</div>
            </div>
            
            <div className="glass-effect rounded-lg p-6 text-center">
              <div className="text-3xl font-bold text-green-400 font-mono mb-2">🎯</div>
              <div className="text-white font-semibold mb-1">Mission Master</div>
              <div className="text-gray-400 text-sm font-mono">Most missions completed</div>
            </div>
          </div>
        </div>
      </div>
