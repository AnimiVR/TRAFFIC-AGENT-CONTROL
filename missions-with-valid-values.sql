-- =====================================================
-- MISSIONS VỚI CÁC GIÁ TRỊ HỢP LỆ
-- =====================================================
...
-- Tạo 1 mission đơn giản với các giá trị hợp lệ theo constraints
INSERT INTO missions (code, title, description, type, location, difficulty, points_reward) VALUES
('CLICK_MISSION', 'Simple Click Mission', 'Click vào nút Join Mission để nhận điểm', 'Intelligence', 'Website', 'Medium', 1);
